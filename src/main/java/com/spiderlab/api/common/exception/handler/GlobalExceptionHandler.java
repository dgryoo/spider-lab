package com.spiderlab.api.common.exception.handler;

import com.spiderlab.api.common.exception.custom.BadRequestException;
import com.spiderlab.api.common.exception.custom.CustomErrorResponse;
import com.spiderlab.api.common.exception.custom.CustomException;
import com.spiderlab.api.common.exception.custom.InternalServerErrorException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> handleException(Exception e, HttpServletRequest httpServletRequest) {
        ...
        logger.error("Path : {}", httpServletRequest.getRequestURI());
